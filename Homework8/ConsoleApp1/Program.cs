...
namespace ConsoleApp1
{
    public class TestClass
    {
        static void Main()
        {
            OrderDetails First = new OrderDetails(01, "wx1",123456, "Cheese", 1, 10);         //设置订单信息
            OrderDetails Second = new OrderDetails(02, "wx2",123789, "Bread", 1, 5);
            OrderDetails Third = new OrderDetails(03, "wx3",456789, "Milk", 2, 5);
